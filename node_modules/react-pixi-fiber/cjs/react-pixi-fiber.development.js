...
var Stage = function (_React$Component) {
  ...
  createClass(Stage, [{
    ...
    value: function componentDidMount() {
      ...
      this._app = new PIXI.Application(width, height, _extends({
        view: this._canvas
      }, options));
